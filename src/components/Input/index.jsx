...
export default function Input() {
    ...
    return (
        <div className={styles.root}>
            ...
            <input value={searchValue} onChange={(event) => onChangeValue(event)}className={styles.input} placeholder="Найти пиццу"/>
        </div>
    )
}